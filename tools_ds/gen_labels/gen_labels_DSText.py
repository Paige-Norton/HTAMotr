...
import numpy as np
import sys
sys.path.append('/home/ubuntu/MOTRv2-trans')
...
from_label_root = "/home/ubuntu/MOTRv2-trans/data/DSText/V2_copy/V2_Ann_xml"

# path of video frames 
seq_root = '/home/ubuntu/MOTRv2-trans/data/DSText/images/train/'

# path to generate the annotation
label_root = '/home/ubuntu/MOTRv2-trans/data/DSText/labels_with_ids/train'
...
gen_data_path(path="/home/ubuntu/MOTRv2-trans/data/DSText")